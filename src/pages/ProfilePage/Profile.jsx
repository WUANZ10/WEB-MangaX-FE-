    ...
    <div className="profile-container">
        <div className={`aside-profile-container ${aside}`}>
          <div className="aside-profile" >
            ...
            <p className="option" onClick={()=>setOptionMenu(<Comic type='follower'/>)}>
              <span className="icon">
                <BookHeart />
              </span>
              Truyện theo dõi
            </p>
            <p className="option" onClick={()=>setOptionMenu(<Comic type='viewed'/>)}>
              <span className="icon">
                <FileClock />
              </span>
              Truyện đã đọc
            </p>
            <p className="option" onClick={()=>setOptionMenu(<Comic type='upload'/>)}>
              <span className="icon">
              <ScrollText />
              </span>
              Truyện đã đăng
          ...
          {aside==='open-aside' ? <span className="aside-action" onClick={()=>openAside('close-aside')}><PanelLeftClose /> </span> : <span className="aside-action" onClick={()=>openAside('open-aside')}><PanelRightClose /></span> }
        </div>
      <div className={`profile-content ${moveContent}`}>
        {optionMenu}
      </div>
    </div>
  );
